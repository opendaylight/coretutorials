...
public class CustomisableLeaseManagerDhcpService extends LeaseManagerDhcpService {
    ...
    public CustomisableLeaseManagerDhcpService(LeaseManager manager, List<LeaseManagerOption> options) throws IllegalArgumentException {
        super(manager);
    ...
    protected void implementOptions(List<LeaseManagerOption> options)  throws IllegalArgumentException {
