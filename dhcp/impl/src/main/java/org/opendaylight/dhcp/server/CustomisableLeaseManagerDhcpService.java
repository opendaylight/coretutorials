    ...
    protected void implementOptions(List<DefaultOption> options)  {
        ...
        for (DefaultOption o : options) {
            try {
                ...
                LOG.warn("Failed to parse DHCP option {}", o.getId());
                continue;
            }
            scope = o.getScope();
