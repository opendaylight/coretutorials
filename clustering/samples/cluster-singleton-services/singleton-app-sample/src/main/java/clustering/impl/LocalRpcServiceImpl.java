...
public class LocalRpcServiceImpl implements ClusteringLocalRpcService {
    ...
    /* (non-Javadoc)
     * @see org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.clustering.local.rpc.rev160722.ClusteringLocalRpcService#localRpc(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.clustering.local.rpc.rev160722.LocalRpcInput)
     */
    @Override
