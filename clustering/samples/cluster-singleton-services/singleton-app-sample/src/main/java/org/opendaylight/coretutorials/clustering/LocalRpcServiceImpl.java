...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.coretutorials.singleton.app.local.rpc.rev160722.LocalSingletonAppRpcInput;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.coretutorials.singleton.app.local.rpc.rev160722.LocalSingletonAppRpcOutput;
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.coretutorials.singleton.app.local.rpc.rev160722.LocalSingletonAppRpcOutputBuilder;
...
public class LocalRpcServiceImpl implements SingletonAppLocalRpcService {
     ...
     * (non-Javadoc)
     * @see
     * org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.coretutorials.singleton.app.local.rpc.rev160722.
     * SingletonAppLocalRpcService#localSingletonAppRpc(org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang
     * .coretutorials.singleton.app.local.rpc.rev160722.LocalSingletonAppRpcInput)
     */
    @Override
