...
class DataContextDeviceSetupBuilder {
    ...
    public DataContextDeviceSetup build() {
        return new DataContextDeviceSetup(this);
    }

    class DataContextDeviceSetup {
        ...
        private DataContextDeviceSetup(final DataContextDeviceSetupBuilder builder) {
