 ...
 */
package singleton.hs.cli.commands;
...
public class SingletonHsCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SingletonHsCliTestCommand.class);
    protected final SingletonHsCliCommands service;

    public SingletonHsCliTestCommand(final SingletonHsCliCommands service) {
