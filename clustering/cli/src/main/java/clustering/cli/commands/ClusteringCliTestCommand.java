 ...
 */
package clustering.cli.commands;
...
public class ClusteringCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ClusteringCliTestCommand.class);
    protected final ClusteringCliCommands service;

    public ClusteringCliTestCommand(final ClusteringCliCommands service) {
