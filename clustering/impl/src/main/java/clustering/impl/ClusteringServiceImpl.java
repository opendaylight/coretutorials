...
import org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.clustering.rev160722.RoutedRpcOutputBuilder;
...
public class ClusteringServiceImpl implements ClusteringService {
    ...
    public Future<RpcResult<RoutedRpcOutput>> routedRpc(RoutedRpcInput input) {
        LOG.info("GlobalRpcExample.routedRpc input: {}", input);
