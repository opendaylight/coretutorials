...
public class ClusteringProvider {
    ...
    private static final ClusteringServiceImpl clusteringServiceImpl = new ClusteringServiceImpl();
    ...
    public void init() {
        ...
        serviceReg = rpcProviderRegistry.addRpcImplementation(ClusteringService.class, clusteringServiceImpl);
    }
