 ...
 */
package sharding.simple.cli.commands;
...
public class ShardingSimpleCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(ShardingSimpleCliTestCommand.class);
    protected final ShardingSimpleCliCommands service;

    public ShardingSimpleCliTestCommand(final ShardingSimpleCliCommands service) {
