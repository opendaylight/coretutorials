...
public class ShardTestStats {
    ...
    private final long dataTreeEventsOk;
    private final long dataTreeEventsFail;
    ...
    ShardTestStats(int txOk, int txError, int txSubmitted, long execTime,
        ...
        this.dataTreeEventsOk = dataTreeEventsOk;
        this.dataTreeEventsFail = dataTreeEventsFail;
    }
