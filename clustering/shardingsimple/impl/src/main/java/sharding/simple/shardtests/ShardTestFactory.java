...
public class ShardTestFactory {
    ...
    public ShardTest createTest(Long numShards, Long numItems, Long numListeners,
            LogicalDatastoreType dataStoreType) throws ShardTestException {
        ...
        try {
            ...
            return new ShardTest(numShards, numItems, numListeners, dataStoreType, shardHelper, dataTreeService);
