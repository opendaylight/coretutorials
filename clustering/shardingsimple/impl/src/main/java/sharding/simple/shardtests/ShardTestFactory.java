...
public class ShardTestFactory {
    ...
    public ShardTestFactory(ShardHelper shardHelper, DOMDataTreeService dataTreeService,
                            DistributedShardFactory distributedShardFactory, DOMDataTreeShardingService dataTreeShardingService, ActorSystemProvider actorSystemProvider, SchemaService schemaService) {
