...
public class ShardTest {
     ...
     * @throws DOMDataTreeShardingConflictException when shards from previous test run could not be cleaned up
     */
    ...
    public void registerValidationListener() throws DOMDataTreeLoopException {
        ...
        dataTreeService.registerListener(new ValidationListener(), treeIds, false, Collections.emptyList());
    }
