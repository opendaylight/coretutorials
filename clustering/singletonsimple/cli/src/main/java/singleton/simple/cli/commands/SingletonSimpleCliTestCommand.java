 ...
 */
package singleton.simple.cli.commands;
...
public class SingletonSimpleCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(SingletonSimpleCliTestCommand.class);
    protected final SingletonSimpleCliCommands service;

    public SingletonSimpleCliTestCommand(final SingletonSimpleCliCommands service) {
