...
parser.add_argument("--dataitems", type=int, default=100000,
                    help="Number of data items in a per-shard data set."
                         "The size of the entire data set is dataitems * shards.")
parser.add_argument("--operations", type=int, default=[1000000], nargs='+',
                    help="Total number of put operations to perform on the data set.")
...
def send_test_request(test_type, datastore, shards, data_items, operations,
    ...
    :param operations: Total number of write operations to perform on the data set
    ...
    data = test_request_template % (test_type, datastore, shards, data_items, operations,
                                    puts_per_tx, listeners, precreate_data, validate_data)
