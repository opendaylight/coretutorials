...
public class BenchmarkModuleTest {
    ...
    public void testCustomValidation() {
        BenchmarkModule module = new BenchmarkModule(mock(ModuleIdentifier.class), mock(DependencyResolver.class));
    ...
    public void testCreateInstance() throws Exception {
        ...
        BenchmarkModule module = new BenchmarkModule(mock(ModuleIdentifier.class), dependencyResolver);
