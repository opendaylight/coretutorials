...
public class HweventsourceBAProvider implements BindingAwareProvider, AutoCloseable {

    private static final Logger LOG = LoggerFactory.getLogger(HweventsourceBAProvider.class);
