...
public class SampleEventSourceGenerator {
    ...
    public SampleEventSourceGenerator(HelloWorldEventSourceManager eventSourceManager,DOMNotificationPublishService domPublish, Short numberSampleEventSources, Short messageGeneratePeriod, String messageText) {
    ...
    private HelloWorldEventSource getNewEvetSource(String identifier){
        ...
        HelloWorldEventSource eventSource = new HelloWorldEventSource(this.domPublish, sourceNode,  this.messageGeneratePeriod, this.messageText);
        return eventSource;
    }
